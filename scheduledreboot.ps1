...
try {
    ...
    Register-ScheduledTask -Action $action -Trigger $trigger -TaskName "SysGroup One time reboot" -Description "Reboots the computer at $rebootDateTime for ticket $ticketNumber" -User "SYSTEM" -RunLevel Highest
